...
public class ActivityServiceImpl implements ActivityService {
    ...
    @Override
    public List<Activity> getActivity(List<String> lists) {
    ...
    @Override
    public List<Activity> seachactivity(Map<String, String> map) {
        List<Activity> activityList =activityDao.seachactivity(map);
        return activityList;
    }
